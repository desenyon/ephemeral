...
---
*Generated by Ephemeral Financial Intelligence*
""",
        "comparison": """
# {title}
...
class ExportEngine:
    ...
    def __init__(self, output_dir: str = None):
        self.output_dir = Path(output_dir or os.path.expanduser("~/Documents/Ephemeral"))
...
class ReproducibilityEngine:
    ...
    def __init__(self, config_dir: str = None):
        self.config_dir = Path(config_dir or os.path.expanduser("~/.ephemeral/reproducibility"))
...
class SessionLogger:
    ...
    def __init__(self, log_dir: str = None):
        self.log_dir = Path(log_dir or os.path.expanduser("~/.ephemeral/logs"))
