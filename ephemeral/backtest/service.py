...
class BacktestService:
    def __init__(self, data_dir: str = "~/.ephemeral/lean_data"):
    ...
    async def run_lean(self, algorithm_file: str, project_dir: str) -> AsyncIterator[Dict[str, Any]]:
        ...
        # Parse results
        os.path.join(project_dir, "backtest-result", f"{project_name}.json") # Filename varies usually?
    ...
    async def create_project(self, name: str, code: str) -> str:
        ...
        # Typically ~/.ephemeral/lean_projects/Name
        projects_dir = os.path.expanduser("~/.ephemeral/lean_projects")
        ...
        # We assume the user has a workspace or we set one up in ~/.ephemeral/lean_data?
