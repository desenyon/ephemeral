...
class OpenAIProvider(BaseLLM):
    ...
    async def generate(
        ...
        if tools:
            ...
            # Prefer multiple tool calls in one assistant turn when appropriate (API default is true;
            # set explicitly so behavior is never serialized to a single call by client defaults).
