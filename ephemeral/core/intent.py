"""Intent parsing and research plan generation for Ephemeral."""
...
class IntentParser:
    ...
    async def parse(self, query: str) -> ResearchPlan:
        ...
        try:
            ...
            has_local_model_host = bool(getattr(settings, "ollama_host", None))
            if has_cloud_key or has_local_model_host:
