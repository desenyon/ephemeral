#!/usr/bin/env python3
"""Verify Textual app wiring and shared UI constants for Sigma v3.7.0."""
...
print("=" * 60)
print("SIGMA v3.7.0 - UI VERIFICATION")
print("=" * 60)
...
try:
    ...
    assert "3.7.0" in WELCOME_BANNER
...
version_match = app_v == cfg_v == "3.7.0"
