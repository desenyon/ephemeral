...
- Error codes and EphemeralError
...
class TestVersion(unittest.TestCase):
    ...
    def test_version_consistency(self):
        ...
        from ephemeral.app import __version__ as app_version
...
class TestErrorCodes(unittest.TestCase):
    """Test error codes and EphemeralError."""
    ...
    def test_ephemeral_error_creation(self):
        """EphemeralError should be properly constructable."""
        from ephemeral.config import EphemeralError, ErrorCode
    ...
    def test_ephemeral_error_to_dict(self):
        """EphemeralError should serialize to dict."""
        from ephemeral.config import EphemeralError, ErrorCode

        error = EphemeralError(ErrorCode.TIMEOUT, "Request timed out")
        d = error.to_dict()
...
class TestConfig(unittest.TestCase):
    ...
    def test_llm_provider_enum(self):
        ...
        from ephemeral.config import LLMProvider
    ...
    def test_save_api_key_providers(self):
        ...
        from ephemeral.config import save_api_key
...
class TestFirstRunDetection(unittest.TestCase):
    ...
    def test_is_first_run_function_exists(self):
        ...
        from ephemeral.config import is_first_run
    ...
    def test_mark_first_run_complete_exists(self):
        ...
        from ephemeral.config import mark_first_run_complete
        self.assertTrue(callable(mark_first_run_complete))

    def test_first_run_marker_path(self):
        """First run marker should be in ~/.ephemeral/."""
        from ephemeral.config import FIRST_RUN_MARKER
        self.assertIn(".ephemeral", str(FIRST_RUN_MARKER))
        self.assertTrue(str(FIRST_RUN_MARKER).endswith(".first_run_complete"))

    def test_config_directory_path(self):
        """Config directory should be ~/.ephemeral/."""
        from ephemeral.config import CONFIG_DIR, CONFIG_FILE
        self.assertIn(".ephemeral", str(CONFIG_DIR))
...
class TestTools(unittest.TestCase):
    ...
    def test_tools_list_exists(self):
        ...
        from ephemeral.tools import TOOLS
    ...
    def test_tool_functions_dict(self):
        ...
        from ephemeral.tools import TOOL_FUNCTIONS, TOOLS
    ...
    def test_polygon_tools_exist(self):
        ...
        from ephemeral.tools import TOOL_FUNCTIONS
    ...
    def test_execute_tool_error_handling(self):
        ...
        from ephemeral.tools import execute_tool
...
class TestLLMClients(unittest.TestCase):
    ...
    def test_llm_provider_classes_exist(self):
        ...
        from ephemeral.llm import AnthropicLLM, GoogleLLM, GroqLLM, OllamaLLM, OpenAILLM, XaiLLM
    ...
    def test_get_llm_raises_ephemeral_error(self):
        """get_llm should raise EphemeralError when API key is missing."""
        from ephemeral.config import EphemeralError, ErrorCode, LLMProvider
        from ephemeral.llm import get_llm

        # Mock settings to have no API key (get_api_key must return None, not a MagicMock)
        with patch("ephemeral.llm.get_settings") as mock_settings:
            settings = MagicMock()
            settings.google_api_key = None
            settings.get_api_key = lambda _p: None
            mock_settings.return_value = settings

            with self.assertRaises(EphemeralError) as context:
    ...
    def test_ollama_requires_no_key(self):
        ...
        from ephemeral.config import LLMProvider
        from ephemeral.llm import OllamaLLM, get_llm
...
class TestRateLimiting(unittest.TestCase):
    ...
    def test_rate_limiters_exist(self):
        ...
        from ephemeral.llm import _rate_limiters
...
class TestAppComponents(unittest.TestCase):
    ...
    def test_suggestions_list(self):
        ...
        from ephemeral.app import SUGGESTIONS
...
class TestPolygonIntegration(unittest.TestCase):
    ...
    def test_polygon_without_key_returns_error(self):
        ...
        from ephemeral.tools import polygon_get_quote

        # Patch where the symbol is bound for polygon_get_quote (library namespace)
        with patch("ephemeral.tools.library._get_polygon_key", return_value=None):
...
class TestBacktesting(unittest.TestCase):
    ...
    def test_strategies_available(self):
        ...
        from ephemeral.backtest import get_available_strategies
    ...
    def test_backtest_tool_defined(self):
        ...
        from ephemeral.backtest import BACKTEST_TOOL
...
def run_interactive_tests():
    ...
    try:
        ...
        print("\n[Config Test]")
        print("  Config directory: ~/.ephemeral/")
        ...
        from ephemeral.tools import get_market_overview
