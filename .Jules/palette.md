...
## 2026-06-19 - Interactive Pane State Hierarchy
**Learning:** Terminal interfaces with multiple interactive panes must clearly indicate the active pane. Cross-pane visual cues and static action hints confuse users.
**Action:** Always scope interactive hints to the active pane, and ensure visual focus highlighting strictly matches the logical state of the component.
