...
## 2026-06-14 - Visual Focus and Active Pane Hierarchy
**Learning:** Mixing cross-pane logical checks for UI states and using inconsistent token colors for active headers causes user confusion about which pane currently has keyboard focus.
**Action:** Strictly match logical focus checks to their respective visual components and consistently apply active styling across both container borders and headers.
