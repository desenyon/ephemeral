...
## 2026-06-30 - Conditionally hide action hints
**Learning:** Interactive action hints (e.g., 'Enter to run') cause visual noise when their associated pane is not focused.
**Action:** Conditionally hide interactive action hints when the terminal is actively busy or the input pane is not focused.
