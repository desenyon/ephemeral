...
## 2026-06-29 - Strict Pane Focus Hierarchy
**Learning:** Mixing cross-pane logical checks for visual focus highlights creates user confusion and visual noise.
**Action:** Ensure visual focus highlighting (border/text colors) strictly matches the logical focusPane state.
