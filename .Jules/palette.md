...
## 2026-06-06 - Conditional Action Hint Clarity
**Learning:** Static action hints like 'Enter to run' create confusing states when the input pane isn't focused or an action is currently running.
**Action:** Hide the 'Enter to run' hint if the input pane isn't focused.
