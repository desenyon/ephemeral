...
## 2026-07-06 - Focus State Consistency
**Learning:** Logical focusPane checks must strictly align with pane visual highlights, and keyboard shortcuts must be clearly distinguishable to aid discoverability.
**Action:** Applied strict focus pane bounds for LeftRail/RightRail and added explicit white bold tags to inline keyboard hints.
