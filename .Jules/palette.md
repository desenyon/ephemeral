...
## 2026-06-07 - Contextual UI Action Hints
**Learning:** Hiding interactive action hints when they are not applicable (e.g., when the terminal is actively busy or the input pane is not focused) prevents user confusion and visual noise.
**Action:** Use conditional logic to only show interactive hints when the user can actually use them.
