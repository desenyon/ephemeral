...
## 2026-07-03 - [Contextual Action Hints]
**Learning:** Conditionally hiding interactive action hints (e.g., 'Enter to run') when they are not applicable, such as when the terminal is actively busy or the input pane is not focused, helps prevent user confusion and visual noise.
**Action:** Always check the focus state and applicability before displaying global or context-specific hints.
