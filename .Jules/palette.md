...
## 2026-06-23 - Consistent Visual Focus Hierarchy
**Learning:** In a multi-pane CLI UI, visual focus cues (borders, text colors) must strictly follow logical focus state to prevent user confusion. Active panes should use consistent highlight colors, while inactive pane UI elements should be dimmed.
**Action:** Align pane headers, borders, and contextual action hints strictly to their specific `focusPane` state, and hide inapplicable input hints.
