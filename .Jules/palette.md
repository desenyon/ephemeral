...
## 2026-06-01 - Contextual Action Hints
**Learning:** Interactive action hints (e.g., 'Enter to run') can cause confusion if displayed when the user cannot actually perform the action (e.g., when the input pane is not focused).
**Action:** Conditionally hide interactive hints based on active pane focus to reduce visual noise.
